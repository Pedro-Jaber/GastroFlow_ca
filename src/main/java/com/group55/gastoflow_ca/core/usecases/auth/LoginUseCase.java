...
public class LoginUseCase {
    ...
    private LoginUseCase(IUserGateway userGateway, IPasswordHasher passwordHasher) {
        this.userGateway = userGateway;
        this.passwordHasher = passwordHasher;
    }

    public static LoginUseCase create(IUserGateway userGateway, IPasswordHasher passwordHasher) {
        return new LoginUseCase(userGateway, passwordHasher);
    }

    public User run(LoginInputDataDTO loginResquest) {
